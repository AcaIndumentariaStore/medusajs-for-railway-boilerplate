...
class MercadoPagoCheckOutProFixed extends AbstractPaymentProcessor {
  static identifier = "Mercado Pago CheckOut Pro Fixed";
...
export default MercadoPagoCheckOutProFixed;
